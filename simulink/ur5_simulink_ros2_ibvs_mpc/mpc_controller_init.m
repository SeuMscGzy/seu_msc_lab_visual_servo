...
mpcobj.OutputVariables(9).Min =  0.1;
...
mpcobj.OutputVariables(9).Max = 0.65;
mpcobj.OutputVariables(11).Max = 0.65;
%the weights of output
mpcobj.Weights.ManipulatedVariables = [20,20,20,20,20,20];
mpcobj.Weights.ManipulatedVariablesRate = [5,5,5,5,5,5];
